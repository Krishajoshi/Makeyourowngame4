...
function createWallPuzzle()
{
   ...
   /* wall1 = createSprite(505, 250, 10,100);
    ...
    //creating the maze
   wall1 = createSprite(550,70,300,20);
 ...
 wall4.shapeColor = "tan";
  ...
  wall9 = createSprite(250,70,20,300);
  wall9.shapeColor = "green";
  wall10 = createSprite(270,150,200,20);
  wall10.shapeColor = "blue";
  wall11 = createSprite(330,50,300,20);
  wall11.shapeColor = "cyan";
  wall12 = createSprite(340,125,20,200);
  wall12.shapeColor = "plum";
  wall13 = createSprite(220,250,20,300);
  wall13.shapeColor = "orchid";
  wall14 = createSprite(330,210,250,20);
  wall14.shapeColor = "magenta";
  wall15 = createSprite(100,300,20,300);
  wall15.shapeColor = "indigo";
  wall16 = createSprite(180,310,200,20);
  wall16.shapeColor = "red";
  wall17 = createSprite(30,352,20,300);
  wall17.shapeColor = "pink";
  wall18 = createSprite(175,352,20,200);
  wall18.shapeColor = "orange";
  wall19 = createSprite(280,290,20,350);
  wall19.shapeColor = "silver";
  wall20 = createSprite(350,270,240,20);
  wall20.shapeColor = "lavender";
  wall21 = createSprite(250,390,230,20);
  wall21.shapeColor = "teal";
  wall22 = createSprite(330,370,20,300);
  wall22.shapeColor = "olive";
